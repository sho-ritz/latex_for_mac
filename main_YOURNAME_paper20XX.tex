...
\vspace{15mm}
\baselineskip=13mm
{\Huge{マルチメディア\\集積回路システム\\LEDマトリクスのフリッカ周波数差を用いたカメラベース可視光通信}}	%論文のタイトル，改行したい場合は\\で区切る
\vspace{7mm}

{\Large
\[ \mbox{Camera-Based Visible Light Communication Using Flicker Frequency Differences of an LED Matrix }\choose
\mbox{method}
\]}		%英語のタイトルをつけるとかっこいい
